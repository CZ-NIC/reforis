        ...
        package_lists: [
            ...
            },
            {
                ...
                labels: [
                    {
                        description:
                            "Using external storage is highly suggested for this package list usage. Software it contains can wear out flash storages as it performs increased amount of writes.",
                        name: "storage",
                        severity: "primary",
                    ...
                    {
                        description:
                            "Software in this package list consumes possibly higher amount of RAM to run. It is not suggested to use it with small memory.",
                        name: "high_memory",
                        severity: "info",
                    ...
                    {
                        description:
                            "This functionality is usable only for advanced users.",
                        name: "advanced",
                        severity: "secondary",
            ...
            },
            {
                ...
                options: [
                    ...
                    {
                        description:
                            "Software RAID storage support using mdadm.",
                        enabled: false,
                        name: "raid",
                        title: "mdadm RAID",
                        labels: [
                    ...
                    {
                        description:
                            "Add support to access encrypted storage devices using dm-crypt.",
                        enabled: false,
                        name: "encrypt",
            ...
            },
            {
                ...
                hidden: true,
                description:
                    "Server side for Turris MOX without SD card used as Wi-Fi access point.",
                name: "netboot",
            ...
            },
            {
                ...
                hidden: false,
                description:
                    "Software for in depth monitoring of your traffic.",
                name: "pakon",
                title: "Pakon",
                labels: [],
                options: [],
